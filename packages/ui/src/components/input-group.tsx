...
function InputGroupContent({
  ...
  return (
    <div
      ...
      className={cn(
        "flex min-w-0 flex-1 cursor-text flex-col justify-center px-2.5 pt-1 **:data-[slot=input-group-control]:px-0",
        className
      )}
      onClick={(e) => {
...
function InputGroupLabel({
  ...
  return (
    <Label
      ...
      className={cn("pointer-events-none cursor-text leading-none", className)}
      {...props}
    />
  )
}
